...
function AppContent() {
  ...
  return (
    <View
      style={[
        styles.root,
        { paddingTop: insets.top, paddingBottom: insets.bottom + keyboardInset },
      ]}>
      ...
      <View style={chatOpen ? styles.chatOverlay : styles.screenHidden}>
...
const styles = StyleSheet.create({
  ...
  // Inside the padded root, so safe-area insets still apply over the tabs.
  chatOverlay: {
    position: 'absolute',
    top: 0,
    right: 0,
