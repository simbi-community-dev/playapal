...
export const TOUR_CARDS: TourCard[] = [
  ...
  },
  {
    ...
    body:
      ...
      'on the answering machine — name someone with @ and their pocket ' +
      'buzzes. Hold the walkie and the pod hears you live, clearer on a ' +
      'shared camp Wi-Fi and rougher without one — and two podmates can ' +
      'step up to a face-to-face call.',
  },
  {
