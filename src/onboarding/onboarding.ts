...
/**
 * Every distinct camp across ENABLED packs, with its placement address —
 * the picker's source. Deduped by camp name (case-insensitively; the first
 * spelling wins) keeping the first non-empty location, because the events
 * table repeats a camp once per event and placement strings drift.
 */
