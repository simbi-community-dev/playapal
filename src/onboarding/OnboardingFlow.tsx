...
/** Guarded screen-reader announcement (a11y review 2026-08-24): progress
 * dots are silent — page changes get said out loud. try/catch so a bridge
 * without AccessibilityInfo (tests) is a no-op, never a crash. */
function announce(message: string): void {
  try {
    AccessibilityInfo.announceForAccessibility(message);
  } catch {
    // no announcer here — the visible step still shows
  }
}
