 ...
 * Times and addresses never come from model prose (the prototype caught the
 * model garbling "6:30 & D" into "6:30 AM"); the model provides conversational
 * glue, these cards provide the facts.
 */
  ...
  return (
    <Pressable
      ...
      <Text style={styles.when}>
        ...
        {[daily ? 'Daily' : event.day, time].filter(Boolean).join(' · ')}
      </Text>
      <Pressable
        onPress={onNavigate}
        disabled={!onNavigate}
