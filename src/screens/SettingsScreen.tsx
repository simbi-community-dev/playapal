...
const styles = StyleSheet.create({
  ...
  infoFlex: { flex: 1 },
  // …and a surviving inline clause with its ? beside it. It keeps `hint`'s
  // own marginTop, which moved off the text and onto the row with it —
  // otherwise the clause hugs the card above. flex on the text so a long
  // clause wraps instead of shoving the glyph off the edge.
  hintRow: {
    alignItems: 'center',
    flexDirection: 'row',
    marginTop: spacing.sm,
