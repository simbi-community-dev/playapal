...
export function FriendsSection({
  ...
  // QR capacity: version-40 codes top out near 2953 bytes; beyond ~1800 the
  // modules are too dense for a dusty across-the-table scan anyway. Larger
  // crews travel by "Beam friends" (share sheet) instead (review 2026-08-19).
