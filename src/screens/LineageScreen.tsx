    ...
    if (!center) {
      return (
        <>
          ...
          {/* THE TUFTE PASS (owner ask 2026-08-26): a DEFINITION of the
              header it sits under — the same sentence for every camp, every
              day. The chips below are the data, and they are readable
              without it. */}
          <View style={styles.headingRow}>
            <Text style={styles.groupHeader}>Your camp's roots</Text>
            <InfoTap
              topic="your camp's roots"
              text={
                'People who brought others in but whose own sponsor nobody ' +
                'has named — as far as the record goes.'
              }
            />
          </View>
...
const styles = StyleSheet.create({
  ...
  // THE TUFTE PASS (2026-08-26): the roots definition moved behind a ?, and
  // `hint` — this file's only user of it — went with it. The header and its
  // glyph share one line; groupHeader keeps its own vertical margins.
