...
const styles = StyleSheet.create({
  ...
  yearText: { color: colors.cream, fontSize: type.tiny, fontWeight: '800' },
  ...
  flagText: { color: colors.cream, fontSize: type.tiny, fontWeight: '900' },
  ...
  backdrop: { flex: 1, backgroundColor: 'rgba(58,47,40,0.45)', justifyContent: 'flex-end' },
