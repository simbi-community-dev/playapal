...
export function PodScreen({
  ...
  /** Whether the Pods tab is the one showing — the card is kept mounted
   * across tab switches, and re-entry is a signal it needs (the
   * mail-on-unread default re-reads on the way back in). */
  active?: boolean;
}) {
  return (
    <View style={styles.container}>
      <CrewSection onOpenCompass={onOpenCompass} active={active} />
    </View>
  );
}
