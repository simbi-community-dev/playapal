 ...
 *
 * Every chat turn (user + assistant + tool traffic), persona switch, pack
 ...
 *   - session_id groups one conversation: new id per app launch (module
 *     state) and per persona switch (the app's only "new chat" boundary).
...
/** New-conversation boundary (persona switch clears the transcript). */
