...
/** Same pre-alloc ceiling as the friend decoder. */
...
/**
 * Does this bundle fit one QR? Checked against the full encoded link (the
 * QR encodes the scheme link, which is a few chars longer than the https
 * one), so a true answer is always scannable.
 */
