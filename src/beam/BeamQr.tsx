 ...
 *
 * Renders the deep link as a QR the system camera scans — the same stance as
 * FriendsSection. (The app can read one itself since 2026-08-25,
 * src/links/scanCode.ts; that is a second READER and changes nothing here.)
