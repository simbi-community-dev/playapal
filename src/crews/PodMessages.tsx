...
export function PodMessages({
  ...
  }, [crew.code, getRecorder, jumpToNewest, me.id]);
      ...
      {open ? (
        <>
          ...
          <Text style={styles.footer}>
            Messages move whenever Playa Pal is open on both phones, hopping
            pod phone to pod phone — seconds when someone is beside you,
            longer when they are across camp. A plugged-in phone at camp
            keeps the mailbox.
          </Text>
        </>
      ) : null}
