 ...
 *
 * Bit 1 (live lo-fi over BLE) is still deliberately un-announced even though
 * rung 3 now SHIPS (the ADPCM codec over GATT, WalkieModule/WalkieBleLink):
 * the rung is proven by its GATT connection, not by the bit, and nothing in
 * this build reads a peer's radios yet. Bit 2 = Wi-Fi Aware (announced
 * below); bit 4 = shared LAN, the floor every phone has. The full bit
 * vocabulary lives in docs/WALKIE-LADDER.md §4 and MemberBody.radios.
 */
