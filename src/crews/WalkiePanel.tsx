    ...
    <View style={styles.wrap}>
      ...
      {open ? (
        <View>
          ...
          <Text style={styles.hint}>
            Some pairs of phones link at full quality; others always come
            through rougher — marked lo-fi. Both carry your voice. If you
            and a podmate can join the same Wi-Fi, more pairs get full
            quality; with no Wi-Fi at all, podmates close by still come
            through lo-fi.
          </Text>
        </View>
      ) : null}
