 ...
 * the system camera scans it, there is no in-app scanner and no camera
 * permission, and the payload rides the fragment so no server ever sees a pod
 * code. Rung 0 is the only rung with NO RADIO — it works with Bluetooth off,
