...
const KNOWN_UNCALLED: Record<string, string> = {
  ...
  __resetPodLandingForTests:
    'explicit test handle; a pod landing is an app-lifetime store',
  ...
  meshAirtimeHeld:
    'test seam: the receive half of the same airtime trade; meshAirtimeHold observes it, production reads the module-scope flag directly',
