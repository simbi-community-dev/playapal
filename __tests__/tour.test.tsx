/**
 * The replayable feature tour (0.7.3, docs/NTY-PATTERNS.md §4): six
...
describe('the feature tour', () => {
  it('ships exactly the six cards, in order', () => {
  ...
  it('Next pages through every card; Back returns', () => {
    ...
    pressText(root, 'Back');
    expect(textOf(root)).toContain(HEADLINES[HEADLINES.length - 2]);
  });
