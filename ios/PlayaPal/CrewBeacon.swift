...
final class CrewBeacon: RCTEventEmitter {
  ...
  override func supportedEvents() -> [String]! {
    [Self.sightingEvent, Self.stateEvent, Self.syncWantEvent]
  }
  ...
  func centralManagerDidUpdateState(_ central: CBCentralManager) {
    ...
    case .poweredOn:
      ...
      central.scanForPeripherals(
        ...
        // Duplicates ON: each repeat sighting refreshes presence liveness;
        // the JS presence store is the dedupe layer, not the radio.
